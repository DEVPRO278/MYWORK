...
echo -e $Purple"
            ...
            ╚██████╔╝██║  ██║╚██████╔╝███████║   ██║     ██╔╝ ██╗    
             ╚═════╝ ╚═╝  ╚═╝ ╚═════╝ ╚══════╝   ╚═╝     ╚═╝  ╚═╝  
				  $BRed https://${BYellow}www.facebook.com/${BGreen}Silent.Ghost.X"
echo ""
echo -e "  $Yellow[1]$Cyan Attack automatic."
echo -e "  $Yellow[2]$Cyan If you want to crack an acces point's key with$BRed WPS PIN."
echo ""
...
echo -e "$Cyan [*]$Green HT-PCR$White By$BYellow Silent Ghost X."
echo ""
